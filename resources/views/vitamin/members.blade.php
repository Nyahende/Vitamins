              ...
              <div class="table-responsive mailbox-messages" style="overflow-y:scroll;height:380px">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td >
                    <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">/ -->
                        <img src="dist/img/user2-160x160.jpg"  style="width:80px;height:80px;border-radius:10px;" alt="User Image">
                        <div class="info">
                        <a href="{{route('userprofile')}}" class="d-block">Alexander Pierce</a>
                        </div>
                    <!-- </div> -->
                    </td>
