            ...
            <div class="tab-content" id="custom-content-below-tabContent">
              ...
              <div class="post">
                      <div class="user-block">
                        ...
                        <span class="description">Beyonce - Halo</span>
                      </div>
                      <!-- /.user-block -->
              ...
              <div class="post">
                      <div class="user-block">
                        ...
                        <span class="description">Akon - Ghetto</span>
                      </div>
                      <!-- /.user-block -->
                      <audio controls class="audiplay" style="width:100%;"> <source src="{{asset('dist/video/Halo.mp4')}}" type="audio/mpeg" style="width:100%;">Your audio format is not supported</audio>
